<?php include 'include/header.php'; ?>
   <div class="more">
   			...
   			<div class="featured">
				...
				?>
   				<a href="article/<?php echo $row['id']; ?>/<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', strtolower(str_replace(' ', '-', trim($row['title']))))."/"; ?>">
	   				...
	   				<div class="featured1" style="background-image: url('image/<?php echo $row['image']; ?>');">
	 					...
	 					<div class="featuredtext">
	 						...
	 						<p>
	 							<?php echo substr($row['text'],0,150)."..."; ?>
	 						</p>
	 					</div>
	   				</div>
   				</a>
   					...
   					<div class="body1">
						...
						<div class="thumbnailh">
							...
							<!-- Post title ends here -->
								...
								<p>
									<a class="link" href="article/<?php echo $row['id']; ?>/<?php echo preg_replace('/[^A-Za-z0-9\-]/', '', strtolower(str_replace(' ', '-', trim($row['title']))))."/"; ?>">Read More</a>
								</p>
